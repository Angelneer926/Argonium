...
def generate_answer(question, config, question_format="auto"):
    ...
    This function is intended to be used together with an external
    ...
    if question_format == "auto":
        ...
        is_mc = any(re.search(pattern, question, re.IGNORECASE) for pattern in mc_patterns)
    ...
    if actual_format == "mc":
        ...
        system_message = (
            ...
            f"Final Answer: <the correct {label_format}>\n"
            "\n"
    ...
    try:
        ...
        # OpenAI doesn't support temperature parameter for some reasoning models
        ...
        # Propagate the exception to trigger external backoff
